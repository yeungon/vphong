...
var nuclei = map[string]string{
	...
	"iê": "iə", "iế": "iə", "iề": "iə", "iểu": "iə", "iễ": "iə", "iệ": "iə",
...
var offglides = map[string]string{
...
var onglides = map[string]string{
...
var onoffglides = map[string]string{
	"oai": "aːj", "oái": "aːj", "oài": "aːj", "oải": "aːj", "oãi": "aːj", "oại": "aːj",
...
var gedneySuper = map[string]string{
	"A1": "ᴬ¹", "A2": "ᴬ²", "B1": "ᴮ¹", "B2": "ᴮ²",
	"C1": "ᶜ¹", "C2": "ᶜ²", "D1": "ᴰ¹", "D2": "ᴰ²",
}

var eightSuper = map[string]string{
	"A1": "¹", "A2": "²", "C1": "³", "C2": "⁴",
	"B1": "⁵", "B2": "⁶", "D1": "⁷", "D2": "⁸",
}

var eightLower = map[string]string{
	"A1": "1", "A2": "2", "C1": "3", "C2": "4",
	"B1": "5", "B2": "6", "D1": "7", "D2": "8",
}

var sixNSuper = map[string]string{
	"A1": "¹", "A2": "²", "C1": "³", "C2": "⁴",
	"B1": "⁵", "B2": "⁶", "D1": "⁵", "D2": "⁶",
}

var sixNLower = map[string]string{
	"A1": "1", "A2": "2", "C1": "3", "C2": "4",
	"B1": "5", "B2": "6", "D1": "5", "D2": "6",
}

var sixSSuper = map[string]string{
	"A1": "¹", "A2": "²", "C1": "³", "C2": "³",
	"B1": "⁵", "B2": "⁶", "D1": "⁵", "D2": "⁶",
}

var sixSLower = map[string]string{
	"A1": "1", "A2": "2", "C1": "3", "C2": "3",
	"B1": "5", "B2": "6", "D1": "5", "D2": "6",
}

var ChaoNSuper = map[string]string{
	"A1": "³³", "A2": "³²", "B1": "²⁴", "B2": "²¹ˀ",
	"C1": "³¹²", "C2": "³ˀ⁵", "D1": "⁴⁵", "D2": "²¹",
}

var ChaoNLower = map[string]string{
	"A1": "33", "A2": "32", "B1": "24", "B2": "21g",
	"C1": "312", "C2": "3g5", "D1": "45", "D2": "21",
}

var ChaoCSuper = map[string]string{
	"A1": "³⁵", "A2": "⁴²", "B1": "²ˀ⁴", "B2": "³¹",
	"C1": "³²ˀ", "C2": "³²ˀ", "D1": "⁴⁵", "D2": "³¹",
}

var ChaoCLower = map[string]string{
	"A1": "35", "A2": "42", "B1": "2g4", "B2": "31",
	"C1": "32g", "C2": "32g", "D1": "45", "D2": "31",
}

var ChaoSSuper = map[string]string{
	"A1": "³³", "A2": "²¹", "B1": "⁴⁵", "B2": "²¹²",
	"C1": "²¹⁴", "C2": "²¹⁴", "D1": "⁴⁵", "D2": "²¹²",
}

var ChaoSLower = map[string]string{
	"A1": "33", "A2": "21", "B1": "45", "B2": "212",
